...
+ Farty dissapears & reappears acording to the map marker. For this reason I won't make the mapmarker dissapear when players get close to the mission. The mission was getting exploited on our servers with players running in to the loot crate, causing Farty to vanish.
